...
from .views.fabrica import (
    FabricaDisponivelView,
    FabricaEtiquetasPdfView,
    FabricaEtiquetasView,
    FabricaProducaoView,
)
from .views.leitura_caixas import LerCaixaView
...
urlpatterns = router.urls + [
    ...
    path('fabrica/etiquetas/pdf/', FabricaEtiquetasPdfView.as_view(), name='fabrica-etiquetas-pdf'),
